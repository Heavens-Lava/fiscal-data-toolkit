...
| `node scripts/household-debt-holders.mjs` | Top FDIC banks by credit-card, auto, other consumer, and real-estate loans | [FDIC](https://banks.data.fdic.gov/docs/) + [FRED](https://fred.stlouisfed.org/) |
...
Or via npm: `npm run fiscal`, `npm run banks`, `npm run holders`, `npm run money`, `npm run trade`, `npm run stock -- AMD`.
